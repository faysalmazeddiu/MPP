...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		List<String> listOfBookTitle=list.stream().filter(c->c.getCheckoutDate().equals(LocalDate.of(2015,6,27)))
		.map(c->c.getCopy().getBook().getTitle())
		.sorted(Comparator.comparing((String e)->e.length()).reversed()).collect(Collectors.toList());
		
		System.out.println(listOfBookTitle);
