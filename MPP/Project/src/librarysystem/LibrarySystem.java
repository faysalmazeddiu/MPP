...
public class LibrarySystem extends JFrame implements LibWindow {
	...
	ListItem[] librarianItems = { loginItem, bookStatus,checkoutBook, allBooks, allCheckouts, allOverdue};
	...
	ListItem[] adminItems = { loginItem, addMember, searchMember, addBook, bookCopy, bookStatus, allCheckouts,allOverdue, allMembers, allBooks }; // my
